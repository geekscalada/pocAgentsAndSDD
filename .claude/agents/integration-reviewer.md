...
Lees código en `apps/angular-app/`, `services/express-api/` e `infra/cdk/` para detectar inconsistencias entre capas. No implementas cambios; producas un informe de problemas y recomendaciones.
...
Cuando revises código para un PR:
