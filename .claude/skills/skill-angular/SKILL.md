...
description: >
  ...
  definidos en una spec OpenAPI. Úsala siempre que el usuario quiera ver código Angular
  para integrar o consumir una API REST, crear un componente o formulario Angular que
  llame a un endpoint concreto, mostrar cómo quedaría código Angular consumiendo un
  contrato OpenAPI, o pida ejemplos Angular con signals, standalone components o
  inject(). Actívala en cuanto el usuario mencione Angular junto a algún endpoint,
  spec, API, método HTTP o formulario de datos — aunque no lo pida explícitamente
  como skill. No activar para preguntas conceptuales de Angular sin contexto de API
  (routing, lazy loading, change detection, etc.) ni para tareas que sean solo de
  backend o diseño de spec.
---
...
> Esta skill añade únicamente los patrones modernos de Angular 21.
